...
const test = (approveTransferState, error) => {
  it('should render the modal for Extend Deposit', () => {
    render(
      <ApprovalTranferModal
        ...
        depositPeriodDays={{ '0x5fad7d4850474383e594afa53cedd57709f994d3da7787d72ecd4d4f0b6e1264': '10' }}
    ...
    switch (approveTransferState) {
      case CONFIRM:
        text = screen.getByText('Extend Lock Period');
        break;
      case APPROVING:
        text = screen.getByText('Extending Lock Period...');
        break;
      case SUCCESS:
        text = screen.getByText('Lock Period Extended!');
        break;
      case ERROR:
