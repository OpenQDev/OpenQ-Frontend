...
describe('AccountModal', () => {
	...
	it('should hide tooltip', async () => {
		// ARRANGE
		render(<ToolTipNew hideToolTip={true} toolTipText="sample text"><Child/></ToolTipNew>
		);
		// ASSERT
	...
	it('should show tooltip styles', async () => {
		// ARRANGE
		render(<ToolTipNew toolTipText="sample text" outerStyles={'outerStyles'} innerStyles={'innerStyles'} hideToolTip={false}><Child/></ToolTipNew>
		);
		// ASSERT
