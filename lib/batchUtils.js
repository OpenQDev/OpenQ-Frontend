...
const getUnclaimedTierWithVolume = async (payoutSchedule, bigNumberTierVolume) => {
  return payoutSchedule.findIndex((value) => ethers.BigNumber.from(value).eq(bigNumberTierVolume));
};
