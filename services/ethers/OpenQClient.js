...
import KYCABI from '../../artifacts/contracts/Mocks/MockKyc.sol/MockKyc.json';
...
class OpenQClient {
  ...
  KYC = (signer) => {
    const contract = new ethers.Contract(process.env.NEXT_PUBLIC_KYC_ADDRESS, KYCABI.abi, signer);
    return contract;
  };
