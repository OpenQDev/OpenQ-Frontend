...
const DevRelHero = () => {
  return (
    <div className='pt-10 sm:pt-10 lg:pt-10 2xl:pt-0 lg:-mb-48'>
        ...
        <div className='flex flex-col justify-content-center items-center '>
          <div className='flex flex-col justify-center items-center lg:text-center px-8'>
            ...
            <div className='text-gray-800 text-2xl 2xl:text-2xl pt-5 2xl:w-[48rem]'>
              The OpenQ DRM gives your DevRel team direct access to every beat in the pulse of your developer ecosystem
            </div>
          </div>
        </div>
