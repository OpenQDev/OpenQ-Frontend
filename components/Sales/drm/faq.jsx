    ...
    <div className=''>
      <div className='flex flex-col px-8 bg-white justify-center items-center lg:text-center pb-20'>
        ...
        <div>
          ...
          <FaqQuestion question='What if projects are closed source?' answer='OpenQ plans to integrate an opt-in Github App offering the ability for private repository maintainers to grant OpenQ access to closed source repositories, so that they can tap into the benefits of discoverability offered on our platform.' />
