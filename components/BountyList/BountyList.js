...
const BountyList = ({ bounties, watchedBounties, loading, complete, getMoreData, getNewData, addCarousel, contractToggle, wizard }) => {
	// Hooks
	...
	return (
		<div className="lg:col-start-2 justify-between justify-self-center space-y-4 w-full pb-8 max-w-[960px] mx-auto">
			<div className="flex flex-wrap gap-4 w-full items-center">
				...
				<MintBountyButton styles={'w-full'} type={'Repeating'} wizard={wizard}/>
			</div>
