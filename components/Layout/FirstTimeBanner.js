	...
	return(
		<>{showBanner && isFirstLaunch ?
			<div className="w-full bg-inactive-accent-inside border-inactive-accent border-b  grid grid-cols-[1fr_1fr_1fr_1fr] content-center py-4 items-center px-4 pr-8">
				...
				<div className='col-start-2 col-end-4 text-[1.4rem] md:text-[1rem] text-center min-w-[300px]'>Welcome to <span className='font-bold text-tinted'>OpenQ!</span> Since it{'\''}s your first time with us, check out our <a className='underline font-bold text-tinted' href="https://vimeo.com/718131976" target="_blank" rel="noopener noreferrer">demo</a>.</div>
