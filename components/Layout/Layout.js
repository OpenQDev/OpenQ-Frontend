	...
	return (
		<div>{showBanner&&isFirstLaunch ?
			<div className="w-full bg-pink-500/20 border-pink-500 border-b h-12 text-white grid grid-cols-wide content-center px-4">
				...
				<div className='col-start-2 col-end-3 text-center'>Welcome to <span className='font-bold'>OpenQ!</span> Since it{'\''}s your first time with us, check out our <a className='underline font-bold text-white/90' href="https://vimeo.com/677467068">demo</a>.</div>
