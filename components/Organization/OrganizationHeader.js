		...
		<div className='px-4 pt-3 flex flex-wrap gap-6 w-full '>
			...
			<div className='flex-1 self-center'>
				...
				<ul className='inline-block text-sm mt-2'>
					...
					{organizationData.twitterUsername && <li className='inline-block'>
						<div className='flex gap-1 mx-1'>
					...
					{organizationData.email && <li className='inline-block'>
						<div className='flex gap-1 mx-1'>
							...
							<a rel="nofollow" itemProp="url" className="text-xs" title="openqlabs" href={`mailto:${organizationData.email}`}>{organizationData.email}</a>
