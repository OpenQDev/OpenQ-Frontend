    ...
    <div className='w-full rounded-sm border border-web-gray p-4'>
      ...
      {repository.url && (
        <a
          ...
          href={`/${organizationData.login}/${repository.name}`}
      ...
      <div className='flex gap-1 mt-2'>
        {repository.languages && (
          <>
            <div
              style={{ backgroundColor: repository.languages[0]?.color }}
              className={'w-3 h-3 my-0.5 rounded-full content-center items-center'}
            />
