	...
	return(
		<Link href={`/showcase/${pr.id}/${pr.address}`}>
			<a className='cursor-pointer' >
				<div className='w-60 h-80 border-web-gray border rounded-lg p-6 flex flex-col align-center'>
					<Image width={240} height={240} src={pr.repository.owner.avatarUrl}/>
					<h2 className='text-lg text-tinted font-bold leading-tight'>{pr.title}</h2>
