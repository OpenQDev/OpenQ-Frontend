...
const BountyLinks = ({ bounty, hideBountyLink }) => {
  ...
  return (
    <div className='flex flex-row font-bold text-xl space-x-4'>
      {!hideBountyLink ? (
        bounty ? (
          <Link
            ...
            legacyBehavior
          >
            <div data-testid='link' id={'bounty-link'} className='cursor-pointer'>
      ...
      {bounty ? (
        <Link href={bounty.url} passHref target='_blank' rel='noreferrer' legacyBehavior>
          <div data-testid='link' id={'github-link'} className='cursor-pointer'>
