	...
	return (
		<div>
			<div className="justify-center items-center font-mont flex overflow-x-hidden overflow-y-auto min-w-[320px]  fixed inset-0 z-50 md:pl-20 outline-none focus:outline-none">
				...
				<div ref={modal}  className=" rounded-sm p-7 max-w-[620px] w-1/3 min-w-[320px] shadow-lg flex flex-col w-full bg-dark-mode outline-none focus:outline-none border-web-gray border">
