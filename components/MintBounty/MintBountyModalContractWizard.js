// Keeping the component for the Contract Wizard
...
const MintBountyModalContractWizard = ({ modalVisibility, hideSubmenu, types }) => {
  // Context
...
export default MintBountyModalContractWizard;
