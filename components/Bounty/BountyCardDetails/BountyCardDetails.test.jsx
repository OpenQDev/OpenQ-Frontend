...
describe('BountyCardDetails', () => {
  ...
  it('should display bubles in correct order', async () => {
    ...
    expect(refundAction).toBeInTheDocument();
    ...
    expect(fundActionOne).toBeInTheDocument();
    ...
    expect(fundActionTwo).toBeInTheDocument();
