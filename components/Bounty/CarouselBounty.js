...
const CarouselBounty = ({bounty}) =>{
	...
	return(
		...
		<div className='border-web-gray bg-dark-mode w-44 sm:w-48 h-64 p-4 pl-2 gap-2 border rounded-lg flex'>
			<svg
				flex-1
			...
			<div className='flex-1 w-36'>
				...
				<p className='text-xs'>{bounty.body.length>220 && bounty.body.slice(0, 165).concat('...')}</p>
			</div>
		</div>
	);
};
