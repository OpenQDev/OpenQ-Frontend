...
const WatchButton = ({unWatchable, bounty})=>{
	...
	return (
		<div>
			{!unWatchable && account &&
				<button onClick={handleWatch} disabled={watchDisabled} className='flex group items-center text-xs text-primary bg-inactive-gray leading-5 h-7 px-3 py-[3px] hover:bg-active-gray rounded-sm border hover:border-border-active border-border-gray'>
					{watchingDisplay  ?
						<>
