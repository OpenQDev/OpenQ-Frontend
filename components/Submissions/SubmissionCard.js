  ...
  return (
    <div className={`min-w-[300px] w-60  border rounded-sm border-border-gray bg-menu-bg`}>
      <div
        ...
        className={
          'flex flex-col p-6 items-center text-[0.8rem] tracking-wider placeholder-input-gray outline-none rounded-sm w-full h-80 mb-1'
        }
      >
        ...
        <Link href={`/showcase/${pr.id}`} className='w-full' legacyBehavior>
        ...
        <div className='text-center pt-2 text-gray-400 w-full'>
          By{' '}
          <Link href={pr.author.url || '/showcase'} className='underline cursor-pointer' legacyBehavior>
        ...
        <Link href={pr.url} target='_blank' className='pt-4 cursor-pointer' rel='noreferrer' legacyBehavior>
          <div id={'github-link'}>
