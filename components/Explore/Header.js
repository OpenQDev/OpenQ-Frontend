    ...
    <header className='flex justify-between items-center max-w-screen-2xl mx-auto lg:pt-24 lg:pb-12 px-5 lg:px-10'>
      <div>
        <Link href='https://medium.com/openqdev/introducing-openq-on-polygon-1b096f74e949' target='_blank'>
          <div className='flex items-center bg-dark-4 border border-gray-600 rounded-xl md:rounded-full px-3 md:px-6 py-2 mt-5 max-w-2xl'>
            ...
            <ChevronRightIcon className='text-gray-400 w-6 h-6 hidden md:inline ml-10' />
          </div>
        </Link>
        <h1 className='max-w-2xl mt-10'>The New Universe For Builders</h1>
